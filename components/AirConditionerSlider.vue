                  ...
                  <tr class="columns">
                   ...
                   <tr class="columns">
                    <td class="column"> <p class="special-price">
                        <span class="price">Tk {{priceFormate(cart_item.discount_price)}}</span>
                      </p></td>
                  </tr>
                   <tr class="columns">
                    <td class="column"> <p class="old-price">
                        <span class="price">Tk {{priceFormate(cart_item.regular_price)}}</span>
                      </p></td>
                  </tr>
                </tbody>
 ...
 <table class="table is-fullwidth is-borderless">
              ...
              <tr
                  ...
                  >
                    ...
                    <td class="column"> <p class="special-price">
                        <span class="price">Tk {{priceFormate(compair_product.discount_price)}}</span>
                      </p></td>
                    <td class="column">
                     <p class="old-price">
                        <span class="price">Tk {{priceFormate(compair_product.regular_price)}}</span>
                      </p>
                    </td>
                    <td class="column">
                       <a
...
export default {
  ...
  methods: {
    ...
    fetchImages() {
      var self = this;
      axios.get("/api/category-slider/"+this.cat_id).then(response => {
        setTimeout(() => {
